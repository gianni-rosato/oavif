...
# libspng (Restored and fixed naming)
...
# rav1e (Using the library directly)
...
# libavif (The Critical Fix)
# We use SYSTEM for everything so it looks at our PKG_CONFIG_PATH
